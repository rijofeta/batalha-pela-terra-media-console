...
import personagens.herois.Elfo;
import personagens.herois.Hobbit;
import personagens.herois.Humano;
...
public class SerializadorPersonagens {
    ...
    private static String FICHEIRO_HEROIS = "src/main/resources/personagens_ser/herois.ser";
    private static String FICHEIRO_BESTAS = "src/main/resources/personagens_ser/bestas.ser";
